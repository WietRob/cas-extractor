...
from cas_extractor.models.evidence import (
    CallEntry, EvidenceArtifact, EvidenceLevel,
    ImportEntry, SourceInfo, SymbolEntry,
)
...
def _resolution_to_kind(resolution: str) -> str:
    ...
    mapping = {
        ...
        "super": "super_call",
        "callback": "callback",
        "unresolved": "call",  # default for unresolved
    }
...
def _symbol_to_dict(sym: SymbolEntry) -> dict[str, Any]:
    ...
    Schema allows: qualified, kind, file, params, returns, decorators, range, fingerprint
    ...
    # NOTE: docstring and base_classes are NOT in schema — omitted
    return d
